            ...
            <?php if (isset($_SESSION['user_id'])): ?>
              ...
              <div>
                <span class="mr-1 text-lg"><?php
                                            ...
                                            echo htmlspecialchars($symbol, ENT_QUOTES, 'UTF-8') . ' '; ?></span>
      ...
      <div class="w-11/12 p-6 rounded-lg shadow-lg">
        ...
        <div class="mb-8">
          <span class="text-5xl"><?php
                                  ...
                                  // 記号と名前を出力
                                  echo htmlspecialchars($symbol, ENT_QUOTES, 'UTF-8') . ' '; ?></span>
          <span class="text-5xl"><? echo htmlspecialchars($user['name'], ENT_QUOTES, 'UTF-8'); ?></span>
        </div>
          ...
          <?php foreach ($feedbacks as $feedback): ?>
            <div style="width: 48%;" class="category-item border border-white p-4 rounded-lg shadow w-full mb-6 px-4" data-category="<?php echo htmlspecialchars($feedback['category'], ENT_QUOTES, 'UTF-8'); ?>">
              ...
              <div id="comments-<?php echo $feedback['id']; ?>" class="hidden mt-4">
                      ...
                      <div class="flex justify-between">
                        <div class="text-xl text-gray-400 flex items-center">
                          ...
                          <div class="mr-1"><?php
                                            ...
                                            // 記号と名前を出力
                                            echo htmlspecialchars($symbol, ENT_QUOTES, 'UTF-8') . ' '; ?></div>
                          <div><? echo htmlspecialchars($comment['commenter_name'], ENT_QUOTES, 'UTF-8'); ?></div>:
                        </div>
                ...
                <!-- コメント投稿フォーム -->
                <form action="./mypage.php" method="POST" class="mt-4">
